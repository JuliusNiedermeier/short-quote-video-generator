...
export const ContextMenuSubContent: ParentComponent<ContextMenuPrimitive.ContextMenuSubContentProps> = (props) => {
...
export const ContextMenuContent: ParentComponent<ContextMenuPrimitive.ContextMenuContentProps> = (props) => {
  const [local, rest] = splitProps(props, ['class']);
...
export const ContextMenuCheckboxItem: ParentComponent<ContextMenuPrimitive.ContextMenuCheckboxItemProps> = (props) => {
...
export const ContextMenuRadioItem: ParentComponent<ContextMenuPrimitive.ContextMenuRadioItemProps> = (props) => {
  const [local, rest] = splitProps(props, ['class', 'children']);
...
export const ContextMenuSeparator: VoidComponent<ContextMenuPrimitive.ContextMenuSeparatorProps> = (props) => {
  const [local, rest] = splitProps(props, ['class']);
