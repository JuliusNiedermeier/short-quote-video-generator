...
export const Toast: ParentComponent<ToastPrimitive.ToastRootProps & VariantProps<typeof toastVariants>> = (props) => {
  const [local, rest] = splitProps(props, ['class', 'variant']);

  return <ToastPrimitive.Root class={cn(toastVariants({ variant: local.variant }), local.class)} {...rest} />;
};
